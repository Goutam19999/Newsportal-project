...
urlpatterns = [
    ...
    path("post-by-category/<int:category_id>/" , views.PostListByCategoryView.as_view(), name="post-by-category-api"),
    ...
    path("post/<int:post_id>/comments/", views.CommentViewSet.as_view(), name = "comment-list-api",),
